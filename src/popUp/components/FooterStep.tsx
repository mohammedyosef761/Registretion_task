  ...
  return (
    <>
      <div className="flex flex-col">
        <button
          type={"button"}
          className={`mt-6 mb-2   w-[244.41px] h-[41.14px] text-white font-bold py-2 px-4  rounded-buttonBorder ${
            inputName
        ...
        {step > 1 && (
          <button
            // type={"button"}
            className={`  mb-3   w-[244.41px] h-[41.14px] border-white text-[#262626] font-bold py-2 px-4  ${"hover:text-primary  "}`}
            onClick={() => setStep(step - 1)}
          >
            Back
          </button>
